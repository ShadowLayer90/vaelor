...
export interface Device {
  ...
  platform?: {
    ...
    board: {
      ...
      /**
       * The chassis form factor the backend read from DMI (`board_info()`),
       * e.g. "notebook", "laptop", "desktop", "mini pc", "tower". Optional
       * because not every platform reports one. The hero illustration reads it
       * to tell a portable machine from a desktop.
       */
      chassis?: string;
    };
    os: {
