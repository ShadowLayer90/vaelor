...
import { Button, Checkbox, Input, Notice, Select, Textarea } from "./ui";
  ...
  return (
    <div className="memory-page">
      ...
      <div className="page-heading">
        ...
        <StatusPill label="Local & private" tone="success" />
      </div>
        ...
        <section className="data-panel memory-create" aria-labelledby="memory-create-title">
          ...
          <form onSubmit={createMemory}>
            ...
            <Checkbox
              checked={pinned}
              id="memory-pinned"
              label={<><strong>Keep in important context</strong><small>Pinned memories are considered on every request.</small></>}
