...
export function WorkloadOperation({
  ...
  return (
    <OperationOwner className="agent-plan--operation" controller={controller} description={jobSummary(activePlanJob)} operation={controller.operation} title="Current setup operation">
