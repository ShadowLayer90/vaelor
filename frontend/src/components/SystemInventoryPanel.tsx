      ...
      <div className="system-inventory__grid">
        ...
        <article className="data-panel system-card system-card--services">
          ...
          <div className="system-update-controls">
            ...
            {updateJob && updateJob.id !== dismissedJobId && (
              <UpdateJobStatus job={updateJob} onDismiss={() => setDismissedJobId(updateJob.id)} />
            )}
            {updates?.staged && !busy.startsWith("update-") && (
              <Notice severity="info">
                Downloaded and staged — not yet installed. Use Install staged updates to apply them.
              </Notice>
            )}
