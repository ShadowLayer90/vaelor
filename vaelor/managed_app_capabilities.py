...
MANAGED_TEMPLATE_LABEL = "io.pironman.template"
...
__all__ = [
    "MANAGED_TEMPLATE_LABEL", "ManagedAppCapabilityReconciler", "builtin_manifests",
    "manifest_for_template", "reconcile_managed_workloads", "safe_published_ports", "stable_managed_app_id",
]
