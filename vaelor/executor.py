...
from .app_catalog import APP_TEMPLATES, render_compose
...
from .executor_network import (
    available_model_port, deployment_copilot_result, ensure_host_port_available,
)
...
class JobExecutor(
    ...
    def _install_template(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        port = raw_port
        content = render_compose(template_id, port)
        compose_existed = compose_file.exists()
        if compose_existed and compose_file.read_text(encoding="utf-8") != content:
